...
*i recently lost access to my old github, therefore this is the new link for the megathread from now on!*
...
## LATEST NEWS
New CRKD Guitar Bundle released as 'The Collectors Bundle'. It features a new look to the guitar based off the Cherry Sunburst Les Paul! Check it out [here!](https://crkd.gg/products/lp-cherry-sunburst-multi-platform-collectors-bundle)

New Guitar Hero 3 PC mod released known as BetterGH3! Watch the trailer and download the mod [here!](https://youtu.be/RWRoxHwAM9E)
...
## ROMHACKS
- [*Custom ISO's](https://docs.google.com/spreadsheets/d/1k75r286Z-JAJtnIrpLd4Isk-VCmwtU8LNCZJhxyJ714/edit?gid=2028105666#gid=2028105666) | *Spreadsheet full of custom game ISO's. Not all work!*
- [JRABES ISO's](https://drive.google.com/drive/folders/1MZ8dCnnS6nNw31tOaPJl2RwSfM5XzTAK) | *JARABES is a member in the community who also makes custom ISO's. This is they're drive.*
- [Guitar Hero Permadeath Mods](https://github.com/FregRB/NS-GH-Permadeath/releases) | *What is permadeath? Miss a note you have to restart entirely. Your end goal is to FC every song in the game without missing a single note. Have fun!*
- [Guitar Hero: Avenged Sevenfold](https://github.com/Ryixu/GuitarHeroA7X/releases) | *This is my (Ryixion) own mod. Im currently making a new version slowly but surely. If your interested, Stay tuned!*
...
- [Full Album Spreadsheet](https://docs.google.com/spreadsheets/d/13Uv6qJ1DTnkpq9V_LgEjwPfMGmlqLGWSLnoQUh0OFSA/edit?gid=473351256#gid=473351256) | *A spreadsheet of full album charts and miscellaneous long charts.*
...
- Better Guitar Hero III PC | *Brand new Guitar Hero 3 mod. Fixes a bunch of GH3PC issues.*
- [Better Guitar Hero III](https://drive.google.com/drive/folders/1gJgm-GjJ70KZ3hVzlDR8e8AQy_Y8D9RU) | *BetterGH3 fixes all of the GH3PC bugs / issues.*
- [*Warriors of Rock+](https://github.com/kernaltrap8/WoR-Plus) | *Developer left the project behind but they want to return. Its still very much a Work in Progress.*
- [Guitar Hero World Tour: Definitive Edition](https://ghwt.de/) | *Its like a Deluxe mod but for Guitar Hero: World Tour (PC), However it is NOT a Deluxe mod. It contains different developers, Different visions.*
- [Rock Band 2 Deluxe](https://rb2dx.milohax.org) | *Rock Band 2 Deluxe mod. Adds quality of life improvements.*
- [Rock Band 3 Deluxe](https://rb3dx.milohax.org) | *Rock Band 3 Deluxe mod. Adds quality of life improvements.*
- [Rock Band 4 Deluxe](https://github.com/hmxmilohax/Rock-Band-4-Deluxe#readme) | *Rock Band 4 Deluxe mod. Adds quality of life improvements.*
- [Rock Band Patches](https://github.com/hmxmilohax/rb-patches) | *Extra Rock Band patches. Not required to use Deluxe mods.*
- [Amplitude Deluxe](https://github.com/hmxmilohax/Amplitude-2016-Deluxe#readme) | *Amplitude Deluxe mod. Adds quality of life improvments. This is a old Harmonix game that is not at all related to Guitar Hero. Although, it IS a rhythm game.*
...
- [*ShadPS4 (Rock Band 4 Optimized)](https://nightly.link/LlysiX/shadPS4/workflows/build/rb4-new) | *ShadPS4 but good for Rock Band 4. Its still a massive work in progress.*


## CONTENT CREATION
- [InputJuice](https://github.com/Ryixu/InputJuice/releases/tag/v1.0.0) | *My (Ryixion) Input viewer.*
- [YAID (Yet Another Input Display)](https://github.com/raphaelgoulart/ya_inputdisplay) | *Input viewer.*
- [Ouvert](https://ouvert.dev/) | *Music request bot.*


## MOD TOOLS
- [Guitar Hero Metronome Tools](https://www.mediafire.com/file/cx9py93jovhfiq4/Hero_Metronome.rar/file) | *Im not fully sure on this tool. If someone knows what this is meant for contact me on [Discord](https://discord.com/) 'ryix.dc'*
- [GHTCP](https://github.com/szymmirr/Open-GHTCP-2021) | *Old Guitar Hero 3 customs importer.*
- [Honeycomb](https://github.com/AddyMills/Honeycomb-GUI) | *Modern Neversoft customs importer.*
- [Nautilus](https://github.com/trojannemo/Nautilus/releases) | *Customs importer to console along with other tools.*
- [Sublime](https://www.sublimetext.com/) | *Text editor.*
- [RAD Tools](https://www.radgametools.com/) | *BIK video extractor*
- [Onyx](https://github.com/mtolly/onyx/releases) | *Chart conversion tool.*
- [PS3 Disc Dumper](https://github.com/13xforever/ps3-disc-dumper/releases) | *Get your stuff legally bro.*


## CHARTING TOOLS
- [Moonscraper](https://github.com/FireFox2000000/Moonscraper-Chart-Editor) | *Modern charting software.*
- [Editor on Fire](https://ignition4.customsforge.com/eof) | *Old charting software. Good for charting vocals.*
- [Reaper](https://www.reaper.fm/) | *Digital Audio Workspace that was used to chart.*
- [Audacity](https://www.audacityteam.org/) | *Digital Audio Workspace commonly used to add a 2 second delay to a song before charting.*
- [StemRoller](https://www.stemroller.com/) | *This is a stem splitter. It splits the song into stems, aka seperate instrument tracks.*
...
- [aWiseMoose](https://www.youtube.com/@aWiseMoose) | *He is a moose... Some may even say a wise moose. He now works at [RedOctane Games](https://www.redoctane.games/) as the community represintive.* 
...
- [Jprez](https://www.twitch.tv/jprez) | *A goated streamer and player.*
- [AceZero](https://www.twitch.tv/acezerorb) | *Mainly a Rock Band streamer, but will play other games like YARG or Guitar Hero.*
- [CarneyJared](https://www.twitch.tv/carnyjared) | *Tap Tap, Spam. Jared pushes the limits of Clone Hero to the max.*
- [MandyRocks](https://www.twitch.tv/mandyr0cks) | *Guitar Hero streamer.*
- [MrElectricNick](https://www.twitch.tv/mrelectricnick) | *Streams mostly console games.*
- [RandyLadyMan](https://www.twitch.tv/randyladyman) | *Streams mainly Clone Hero and YARG*
...
- [Xbox 360 Hypervisor Exploit](https://youtu.be/rL8kXxGe8vs)
- [Post RGH Mod](https://youtu.be/CzZpAcCc42M)
- [Xbox 360 NTCS to PAL](https://www.youtube.com/watch?v=0vOnXxlL0NU)
- [Xbox 360 Save Transfer](https://www.youtube.com/watch?v=iuwlny3bFXk)
